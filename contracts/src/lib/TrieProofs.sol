...
/*
Forked from: https://github.com/aragon/evm-storage-proofs/blob/master/packages/evm/contracts/lib/TrieProofs.sol
*/
...
library TrieProofs {
    ...
    function getNextHash(RLP.RLPItem memory node)
        internal
        pure
        returns (bytes32 nextHash)
    {
     ...
     */
    function extractNibble(bytes32 path, uint256 position)
        internal
        pure
